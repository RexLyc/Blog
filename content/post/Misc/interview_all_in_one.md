...
1. Cache是什么，L1、L2、L3的速度是什么样的？
   - 一般来说，L1/L2 缓存是一个物理核自己有一个，都是SRAM，L1大约3个周期（追求低延时），L2大约10个周期（追求带宽）。
   - L3是所有核心共享的，容量更大，可能是SRAM、STT_MRAM、eDRAM来实现。
